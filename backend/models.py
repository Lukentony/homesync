...
from sqlalchemy import ForeignKey, String, Integer, Boolean, DateTime, Date, Text, CheckConstraint
...
class User(Base):
    ...
    pin_hash: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
